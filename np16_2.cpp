...
NP16_2::NP16_2(uint8_t *mem, uint64_t mem_size):
 CPU_Base(32, 32, 32, 16, 16, mem_size, mem) {
}

NP16_2::~NP16_2() {}

uint64_t NP16_2::step(uint8_t &instruction_length) {
...
void NP16_2::fire_interrupt(uint8_t interrupt) {
...
void NP16_2::fire_exception(uint8_t cause, uint32_t bvaddr) {
...
char *NP16_2::decode(uint64_t address) {
	char *name = "<unknown>";
